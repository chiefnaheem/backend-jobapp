...
export const connectDB = () => {
  try {
    mongoose.connect('mongodb+srv://chiefnaheem:£NAHeem199@cluster0.styhr.mongodb.net/JOB-APP?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true }).then(() => {
